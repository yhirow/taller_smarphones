...
class servicio_cliente extends fs_model
{
    ...
    public function __construct($data = FALSE)
    {
        ...
        if ($data) {
            ...
            $this->tipomarca = $data['tipomarca'];
            $this->nummodelo = $data['nummodelo'];
            $this->tipocolor = $data['tipocolor'];
        ...
        if ($this->test()) {
            ...
            if ($this->exists()) {
                $sql = "UPDATE " . $this->table_name . " SET apartado = " . $this->var2str($this->apartado)
                    ...
                    . ", tipomarca = " . $this->var2str($this->tipomarca)
                    . ", nummodelo = " . $this->var2str($this->nummodelo)
                    . ", tipocolor = " . $this->var2str($this->tipocolor)
                    . ", imei1 = " . $this->var2str($this->imei1)
                    . ", imei2 = " . $this->var2str($this->imei2)
            ...
            $sql = "INSERT INTO " . $this->table_name . " (apartado,cifnif,ciudad,codagente,codalmacen,
               ...
               material_estado,tipomarca,nummodelo,tipocolor,imei1,imei2,equipo,condequipo,reparacion,esp_reparacion,accesorios,prioridad,numero2,idestado,editable,horainicio,horafin,femail,numdocs)
                ...
                . "," . $this->var2str($this->tipomarca)
                . "," . $this->var2str($this->nummodelo)
                . "," . $this->var2str($this->tipocolor)
                . "," . $this->var2str($this->imei1)
                . "," . $this->var2str($this->imei2)
