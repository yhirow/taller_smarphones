    ...
    private function nuevo_servicio_cliente()
    {
        ...
        if ($continuar) {
            ...
            if (isset($_POST['tipomarca'])) {
                $servicio->tipomarca = $_POST['tipomarca'];
            }
            if (isset($_POST['nummodelo'])) {
                $servicio->nummodelo = $_POST['nummodelo'];
            }
            if (isset($_POST['tipocolor'])) {
                $servicio->tipocolor = $_POST['tipocolor'];
            }
            if (isset($_POST['imei1'])) {
                $servicio->imei1 = $_POST['imei1'];
            }
            if (isset($_POST['imei2'])) {
                $servicio->imei2 = $_POST['imei2'];
            }
            if (isset($_POST['equipo'])) {
                $servicio->equipo = $_POST['equipo'];
            }
            if (isset($_POST['condequipo'])) {
                $servicio->condequipo = $_POST['condequipo'];
            }
            if (isset($_POST['reparacion'])) {
                $servicio->reparacion = $_POST['reparacion'];
            }
