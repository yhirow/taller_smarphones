...
class imprimir_servicio extends fs_controller
{
    ...
    private function generar_pdf_datos_cliente(&$pdf_doc, &$lppag)
    {
        ...
        $pdf_doc->add_table_row(
            array(
                'campo1' => "<b>" . $this->setup['st_tipomarca'] . ":</b>",
                'dato1' => $pdf_doc->fix_html($this->servicio->tipomarca),
                'campo2' => "<b>" . $this->setup['st_nummodelo'] . ":</b>",
                'dato2' => $this->servicio->nummodelo
            )
        );
        $pdf_doc->add_table_row(
            array(
                'campo1' => "<b>" . $this->setup['st_imei1'] . ":</b>",
                'dato1' => $pdf_doc->fix_html($this->servicio->imei1),
                'campo2' => "<b>" . $this->setup['st_imei2'] . ":</b>",
                'dato2' => $this->servicio->imei2
            )
        );$pdf_doc->add_table_row(
            array(
                'campo1' => "<b>" . $this->setup['st_equipo'] . ":</b>",
                'dato1' => $pdf_doc->fix_html($this->servicio->equipo),
                'campo2' => "<b>" . $this->setup['st_condequipo'] . ":</b>",
                'dato2' => $this->servicio->condequipo
            )
        );
        $pdf_doc->add_table_row(
            array(
                'campo1' => "<b>" . $this->setup['st_reparacion'] . ":</b>",
                'dato1' => $pdf_doc->fix_html($this->servicio->reparacion),
                'campo2' => "<b>" . $this->setup['st_esp_reparacion'] . ":</b>",
                'dato2' => $this->servicio->esp_reparacion
            )
        );
        $pdf_doc->add_table_row(
            array(
                ...
                'campo2' => "<b>" . $this->setup['st_tipocolor'] . ":</b>",
                'dato2' => $this->servicio->tipocolor
            )
        );
        $pdf_doc->add_table_row(
            array(
